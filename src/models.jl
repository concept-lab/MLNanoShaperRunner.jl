...
function tiny_angular_dense(; van_der_waals_channel = false, kargs...)
    general_angular_dense(
        ...
        name = "tiny_angular_dense" * (van_der_waals_channel ? "_v" : ""),
...
function light_angular_dense(; van_der_waals_channel = false, kargs...)
    general_angular_dense(
        ...
        name = "light_angular_dense" * (van_der_waals_channel ? "_v" : ""),
        van_der_waals_channel,
        kargs...,
    )
end

function medium_angular_dense(; van_der_waals_channel = false, kargs...)
    general_angular_dense(
        Parallel(
            .*,
        ...
        name = "medium_angular_dense" * (van_der_waals_channel ? "_v" : ""),
        van_der_waals_channel,
        kargs...,
    )
end
...
production_instantiate((; model, parameters, states)::SerializedModel) =
