...
function symetrise((; dots, r_1, r_2, d_1, d_2)::PreprocessData;cutoff_radius)
	vcat(dots, r_1 .+ r_2, abs.(r_1 .- r_2), d_1 .+ d_2, abs.(d_1 .- d_2)) .* cut.(cutoff_radius,r_1) .*cut(cutoff_radius,r_2)
end
